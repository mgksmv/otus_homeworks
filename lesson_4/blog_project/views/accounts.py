...
from lesson_4.blog_project.forms import SingUpForm, LoginForm, EditUserForm, ResetEmailForm, ResetPasswordForm
from lesson_4.blog_project.models import db, User, Blog
...
def get_user_profile(user_id):
    ...
    return render_template('user_profile.html', user=user, user_blogs=user_blogs)
