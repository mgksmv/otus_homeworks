...
class Game:
    ...
    def human_vs_ai(self):
        card_user = Card()
        card_user.numbers = card_user.generate_card()
        card_ai = Card()
        card_ai.numbers = card_ai.generate_card()
    ...
    def ai_vs_ai(self):
        card_ai_1 = Card()
        card_ai_1.numbers = card_ai_1.generate_card()
        card_ai_2 = Card()
        card_ai_2.numbers = card_ai_2.generate_card()
    ...
    def multiplayer(self, players):
        ...
        for i in range(players):
            new_card = Card()
            new_card.numbers = new_card.generate_card()
            cards[i] = new_card
