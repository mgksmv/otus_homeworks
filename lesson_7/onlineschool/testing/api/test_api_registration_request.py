...
class Tests:
    def test_registration_request_list_unauthorized(self, client):
        response = client.get(PATH)

        assert response.status_code == HTTP_401_UNAUTHORIZED

    def test_registration_request_list_authorized_teacher_empty(self, user_teacher, token_teacher):
    ...
    def test_registration_request_list_authorized_teacher(self, user_teacher, user_student, token_teacher, course):
    ...
    def test_registration_request_list_authorized_student(self, user_student, token_student):
        api_client = APIClient()
