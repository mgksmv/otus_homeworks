    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(to='onlineschool.student', verbose_name='Студенты')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='course',
            name='reviews',
            field=models.ManyToManyField(blank=True, to='onlineschool.review', verbose_name='Отзывы'),
        ),
        migrations.AddField(
            model_name='course',
            name='teachers',
